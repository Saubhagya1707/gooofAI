...
5. If all lessons are complete, suggest taking the quiz with `/waypoint.academy.quiz`
...
4. If all lessons in the module are done, suggest: "All lessons complete! Try `/waypoint.academy.quiz` to take the quiz."
