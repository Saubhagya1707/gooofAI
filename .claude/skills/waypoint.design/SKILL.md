...
- **Step 1**: Understand emotional user needs, not just functional
- **Step 2**: Define 3-5 experience principles that guide all design decisions
- **Step 3**: Create Mermaid journey diagrams for key user interactions
- **Step 4**: Establish color, typography, and spacing philosophy
- **Step 5**: Plan reusable component library approach
- **Step 6**: Ensure WCAG 2.1 AA compliance by design
- **Step 7**: Compile into complete frontend specification document
...
_WayPoint Design command for unknown stack + Simple Layered_