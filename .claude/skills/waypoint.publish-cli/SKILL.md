---
description: "Publish waypoint-cli to npm via CI/CD pipeline"
---

# WayPoint: Publish CLI Action
...
_WayPoint Publish CLI command for unknown stack + Simple Layered_